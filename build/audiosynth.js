...
var setPrivateVar = function setPrivateVar(n, v, w, e) {
  Object.defineProperty(this, n, { value: v, writable: !!w, enumerable: !!e });
};
var setPublicVar = function setPublicVar(n, v, w) {
...
setPub('generate', function (sound, note, octave, duration) {
  ...
  if (typeof this._fileCache[sound][octave - 1][note][time] != 'undefined') {
    ...
    var out = ['RIFF', pack(1, 4 + (8 + 24 /* chunk 1 length */) + (8 + 8 /* chunk 2 length */)), // Length
    'WAVE',
    // chunk 1
    ...
    pack(0, channels * bitsPerSample / 8), pack(0, bitsPerSample),
    // chunk 2
...
module.exports = {
  ...
  AudioSynthInstrument: AudioSynthInstrument
};